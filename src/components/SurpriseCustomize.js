...
// const surpriseFilter = () => (
//   <div>
//     for (let i = 0; i < imgUrl.length; i++) {
//       children.push(
//         <div class="circle">
//           <img src="{imgURL.url[i]}"></img>
//         </div>
//       )
//     }
    ...
    return(
      <div>
        ...
        <div id="all-filters">
          ...
          <div class="filter">
            <div class="circle">
              {/* trying to add icon to each circle, any way to make this and label loop through the redux file?? */}
              {/* <img src={imgURL.url[0]}></img> */}
            </div>
