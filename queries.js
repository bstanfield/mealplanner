...
// LOCAL DEV:
// const db = pgp('postgres://postgres:simplepassword@127.0.0.1:3333/postgres');

// PRODUCTION: 
const db = pgp('postgres://postgres:simplepassword@35.185.213.57:80/postgres');
...
const getRecipeNames = (req, res) => {
  db.query('SELECT recipe_name, image_url FROM recipe_master')
  .then((data) => {
